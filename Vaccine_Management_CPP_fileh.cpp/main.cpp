...
BY : 77. Chanchal Zope
     57. Khushi Vishwakarma
     60. Sakshi Wanare
     54. Vaibhavee Thorat
     40. Sakshi Pokale
*/
// VACCINE MANAGEMENT SYSTEM USING FILE HANDLING IN CPP
...
A:
    ...
    cout << "\n\t\t 1. Show Vaccine Stock";
    cout << "\n\t\t 2. Show Patient Data";
    cout << "\n\t\t 3. Show Total Number Of Vaccines Applied";
    cout << "\n\t\t 4. Add New Doctor Data";
    cout << "\n\t\t 5. Search Doctor Data";
    cout << "\n\t\t 6. Show Doctor Data";
    cout << "\n\t\t 7. LOG OUT";
    cout << "\n\n\t\tEnter Choice: ";
    cin >> admin_choice;
...
B:
    ...
    // USER MENU OPTIONS
    cout << "\n\n\t\t -->> USER MENU <<--";
    cout << "\n\t\t 1. Apply For Vaccine First Dose";
    cout << "\n\t\t 2. Show Details";
    cout << "\n\t\t 3. LOG OUT";
    cout << "\n\n\t\tEnter Choice: ";
    cin >> user_choice;
...
void covid_management::display_vaccine_stock()
{
    ...
    string text;
    fstream file;
    file.open ("vaccine_stock.txt", ios::out | ios::in );
    file >> text;
    //cout<<"Total number of vaccines available are: "<<text<<endl;
    cout << "\n\nAvailable Number Of Vaccines are: " << text;
    cout << "\n\nPress Any Key To Continue..";
    getch();
}
...
void covid_management::update_vaccine_stock()
{
      int text;
      fstream file;
      file.open ("vaccine_stock.txt", ios::out | ios::in );
      ...
      file.close();
      text = text - 1;
      ofstream fout("vaccine_stock.txt");
	  //cout<<endl<<"Writing in a file"<<text<<endl;
      fout<<text;
	  fout.close();
}
...
/*void covid_management::update_patient_data()
{
    ...
    while (!file.eof())
    {
        if (maadhaar.compare(adhaar) == 0)
        {
            ...
            if(dose == 2)
            {
                cout<<"You are fully vaccinated"<<endl;
                cout << "\nDose: " << dose;
            ...
            {
                cout<<"You can apply for 2nd Dose"<,endl;
                endl;
                break;
            }
        }
